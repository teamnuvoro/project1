...
import { Send, Loader2, Mic, Sparkles, Smile } from "lucide-react";
  ...
  return (
    <div className="bg-white border-t border-gray-100 px-4 py-3 space-y-3">
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          onClick={() => {
            // Sticker button - can be extended to show sticker picker
            const emoji = "😊";
            setMessage(prev => prev + emoji);
          }}
          disabled={isLoading || disabled}
          className="p-3 rounded-full bg-gray-100 text-gray-500 hover:bg-gray-200 transition-all disabled:opacity-50"
