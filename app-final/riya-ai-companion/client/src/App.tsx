...
import { TrackerSkeleton } from "@/components/TrackerComponents";
import ChatPage from "@/pages/ChatPage";
import CallPage from "@/pages/CallPage";
import SummaryPage from "@/pages/SummaryPage";
import AnalyticsPage from "@/pages/AnalyticsPage";

const SummaryTrackerPage = lazy(() => import("@/pages/SummaryTrackerPage"));
...
function Router() {
  ...
  const sidebarRoutes = ['/chat', '/call', '/summary', '/tracker', '/analytics', '/settings', '/memories', '/gallery', '/history', '/payment/callback'];
      ...
      <Route path="/tracker">
        {() => (
          <Suspense fallback={<TrackerSkeleton />}>
            <ProtectedRoute component={SummaryTrackerPage} />
          </Suspense>
        )}
      </Route>
